...
describe('app.js', () => {
    describe('valid', () => {
        it('should have a valid university email', done => {
            ...
            const validemail2 = 'fhs39850@fh-salzburg.ac.at';

            expect(app.valid(validemail)).to.be.true;
            expect(app.valid(validemail2)).to.be.true;
        });
    ...
    describe('degreeProgramm', () => {
        it('should have a valid university email', done => {
            ...
            expect(app.degreeProgramm(validemail)).to.equal('multimediatechnology');
            expect(app.degreeProgramm(validemail2)).to.equal('hebame');
